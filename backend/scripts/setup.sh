...
MYSQL_HOST=mysql
MYSQL_PORT=3306
MYSQL_DATABASE=byteverse_db
MYSQL_USER=byteverse_user
MYSQL_PASSWORD=byteverse_pass
...
echo "🐬 MySQL:            mysql://byteverse_user:byteverse_pass@localhost:3306/byteverse_db"
