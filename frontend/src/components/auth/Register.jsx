...
import { validateCleanText, validatePassword } from '../../utils/validators';
      ...
      <section className="auth-form-side">
        <div className="auth-card auth-card-register">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            <label><span>Nombre completo</span><div className="auth-input-wrap"><UserIcon /><input type="text" name="nombre" value={formData.nombre} onChange={(e) => setFormData({ ...formData, nombre: e.target.value })} required autoComplete="name" placeholder="Tu nombre y apellido" /></div></label>
