...
const roleLinks = {
  ADMIN: [
    ...
    { name: 'Promociones', path: '/admin/coupons', icon: TicketIcon },
  ...
  VENDEDOR: [
    ...
    { name: 'Punto de venta', path: '/vendor/pos', icon: ShoppingCartIcon },
    { name: 'Clientes', path: '/vendor/search-client', icon: MagnifyingGlassIcon },
    { name: 'Ventas', path: '/vendor/orders', icon: ClipboardDocumentListIcon },
    { name: 'Catálogo y stock', path: '/vendor/products', icon: ShoppingBagIcon },
    { name: 'Reportes', path: '/vendor/reports', icon: DocumentTextIcon },
    { name: 'Mi perfil', path: '/vendor/profile', icon: UserIcon },
  ],
  COMPRADOR: [
    { name: 'Mi resumen', path: '/buyer', icon: Squares2X2Icon },
